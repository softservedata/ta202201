package com.softserve.edu11reg;
...
public class AppRegex {
	public static void main(String[] args) {
		...
		//String text = "text Now is the time Now is the time text";
		//
		//String pattern ="[bt]{2}";
		...
		*/
		//
		//String pattern = "\\b\\w+(\\.\\w+)*@(\\w+\\.)+\\w{2,}(\\s|$)";
		//System.out.println("Pattern = " + pattern);
		//String text = "a.bd.c@gmail.com";
		//String text = "text a.b.c@gmail.com a@i.ua a.@gmail.com a@gmail.com.a text";
		//
		//String pattern = "\\b(\\d{1,3}[,'])*\\d{1,3}\\.\\d{2}\\b";
		//tring pattern = "\\b\\d{1,3}([,']\\d{3})*\\.\\d{2}\\b";
