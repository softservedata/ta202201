...
public class Appl {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("monthDays = " + monthDays); // .toString() fro Object;
        ...
        //
        System.out.println("Compare Arrays isEqual:");
        boolean isEqual = true;
        for (int i = 0; i < monthDays.length; i = i + 1) {
            if (!isEqual) {
                break;
            }
            if (monthDays[i] != monthDays3[i]) {
                isEqual = false;
            }
        }
        ...
        //
        isEqual = true;
        for (int i = 0; isEqual && i < monthDays.length; i++) {
        ...
        */
        ...
        while (k < monthDays.length) {
            ...
            //System.out.print("k = " + k + "  monthDays[k] = ");
            //System.out.println(monthDays[k]);
            k++;
        }
        */
        /*
